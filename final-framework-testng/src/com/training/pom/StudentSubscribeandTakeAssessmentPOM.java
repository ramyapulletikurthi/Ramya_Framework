...
public class StudentSubscribeandTakeAssessmentPOM {
	...
	@FindBy(xpath = "//img[@title='selenium123']")
	private WebElement student_opencourse;
	...
	public void subscribeCourse(String courseName) {
		...
		boolean enabled = driver.findElement(By.xpath(courseActualXpath)).isEnabled();//xpath of subscribe button
		if (enabled == true) {
